...
export class NFTExchange__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class NFTExchange extends ethereum.SmartContract {
  ...
  getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): NFTExchange__getListingResultValue0Struct {
    ...
    return changetype<NFTExchange__getListingResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<NFTExchange__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<NFTExchange__getListingResultValue0Struct>(value[0].toTuple())
    );
  }
